...
# 步骤标记: [步骤1] ~ [步骤15]（四阶段: 阶段一V1基线1-3 / 阶段二V2使能GT 4-8 / 阶段三V3插件 9-12 / 阶段四V4优化 13-15；5/7为条件触发的算子调优步骤）
...
class ProgressBar:
    """15 步进度条，实时刷新在终端（四阶段: 1-3 V1基线 / 4-8 V2使能GT / 9-12 V3插件 / 13-15 V4优化；5/7为条件触发的算子调优步骤）"""
